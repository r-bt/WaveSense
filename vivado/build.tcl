...
#
# build.tcl: Tcl script for re-creating project 'wave_sense'
#
# Generated by Vivado on Fri Nov 08 14:52:36 EST 2024
...
#
#    "/home/rbeattie/wave_sense/wave_sense.srcs/constrs_1/new/base.xdc"
#    "/home/rbeattie/wave_sense/wave_sense.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../wave_sense/wave_sense.srcs/constrs_1/new/base.xdc"]"\
 "[file normalize "$origin_dir/../../../wave_sense/wave_sense.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../../ip_repo/csi_extractor_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "wave_sense"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../wave_sense"]"
...
set file "[file normalize "$origin_dir/../../../wave_sense/wave_sense.srcs/constrs_1/new/base.xdc"]"
...
\
  ...
  connect_bd_net -net csi_extractor_0_trigger [get_bd_pins csi_extractor_0/trigger] [get_bd_ports led]
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../wave_sense/wave_sense.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
